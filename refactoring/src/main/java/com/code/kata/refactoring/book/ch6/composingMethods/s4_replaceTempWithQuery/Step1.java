package com.code.kata.refactoring.book.ch6.composingMethods.s4_replaceTempWithQuery;
...
public class Step1 {
    ...
    /**
     *  Test they are assigned only once by declaring them as final.
     *  If there is a problem, I should't be doing this refactoring.
     */
    double getPrice(){
        //Inline Temp
