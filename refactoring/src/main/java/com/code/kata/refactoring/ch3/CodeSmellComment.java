...
public class CodeSmellComment {
    /**
     ...
     eliminate this duplication by using Extract Method(提炼函数 89) in both classes then Pull Up Method. If the code is similar but
     not the same, you need to use Extract Method(提炼函数 89) to separate the similar bits from the different bits. You may then
     ...
     -- Extract Method(提炼函数 89)
     b. The same expression in the sibling subclass
     -- Extract Method(提炼函数 89) -> Pull Up Filed
     c. Code is similar but not the same
     -- Extract Method(提炼函数 89) -> Form Template Method
     ...
     method is Extract Method(提炼函数 89). Find parts of the method that seem to go nicely together and make a new method.
        If you have a method with lots of parameters and temporary variables, these elements get in the way of extracting
     methods. If you try to use Extract Method(提炼函数 89), you end up passing so many of the parameters and temporary variables as
     ...
     use Extract Method(提炼函数 89) on the jealous bit and Move Method to give it a dream home.
     ...
     This step is often made easier if Extract Method(提炼函数 89) is used to break the method into pieces that go into different places.
     ...
     -- Extract Method(提炼函数 89) --> Move Method
     ...
     So use Extract Method(提炼函数 89) to extract the switch statement and then Move Method to get it onto the class where polymorphism is
     ...
     a. You want the method or class that hosts the type code value. So use Extract Method(提炼函数 89) to extract the switch statement and
     ...
     -- Extract Method(提炼函数 89) --> Move Method --> Replace Type Code With Subclasses or Replace Code With State/Strategy
     ...
     alternative is to see what the resulting object is used for. See whether you can use Extract Method(提炼函数 89) to take a pieces
     ...
     -- Hide Delegate
     b. Often a better alternative is to see what the resulting object is used for. See whether you can use Extract Method(提炼函数 89)
     ...
     into the data class. If you can't move a whole method, use Extract Method(提炼函数 89) to create a method that can be moved. After
     ...
     into the data class.
     -- Move Method
     e. If you can't move a whole method, use Extract Method(提炼函数 89) to create a method that can be moved. After a while you can
     start using Hide Method on the getters and setters.
     -- Extract Method(提炼函数 89) --> Hide Method
     ...
     If you need a comment to explain what a block of code does, try Extract Method(提炼函数 89).If the method is already extracted but
     ...
     a. If you need a comment to explain what a block of code does, try Extract Method(提炼函数 89).
     -- Extract Method(提炼函数 89)
